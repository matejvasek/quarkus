...
public class FunctionInvoker {
    ...
    public void invoke(FunqyServerRequest request, FunqyServerResponse response) {
        ...
        try {
            ...
            if (isAsync()) {
                ...
                Uni<?> withWrappedException = u.onFailure().apply(t -> new ApplicationException(t));
            ...
            response.setOutput(exceptionalUni(ex));
            throw ex;
    ...
    private static Uni<?> exceptionalUni(Throwable t) {
